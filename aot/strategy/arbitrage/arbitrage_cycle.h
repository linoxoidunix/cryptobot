...
class ArbitrageCycle : public std::vector<Step> {
  public:
    ...
    bool IsTransactionOpen() const { return open_; }
    common::Nanos GetDelta() const { return time_close_ - time_open_; }
    void SetDeltaPrice(common::Price delta) { delta_ = delta; }
    void SetBuyInput(common::Price buy_input) { buy_input_ = buy_input; }
    void SetSellInput(common::Price sell_input) { sell_input_ = sell_input; }
    void SetBuyExit(common::Price buy_exit) { buy_exit_ = buy_exit; }
    void SetSellExit(common::Price sell_exit) { sell_exit_ = sell_exit; }
    void SetPositionOpen(common::Qty position) { position_open_ = position; }
