...
Exchange::MEMarketUpdate::MEMarketUpdate(
    const MEMarketUpdateDouble *market_update_double, uint precission_price, uint precission_qty)
...
Exchange::MEMarketUpdateDouble::MEMarketUpdateDouble(
    const MEMarketUpdate *market_update, uint precission_price, uint precission_qty) :
